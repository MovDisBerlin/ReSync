...
def check_timeshift(
    ...
    #import settings
    json_filename = (saving_path + '\\parameters_' + str(sub_ID) + '.json')  # dont forget json extension
    ...
    ax1.axvline(x=last_artefact_lfp_x, ymin=min(LFP_channel_offset), ymax=max(LFP_channel_offset), color='black', linestyle='dashed', alpha=.3)
